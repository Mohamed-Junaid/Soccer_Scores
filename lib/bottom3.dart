...
import 'package:soccer/laliga.dart';
...
class _bottom3State extends State<bottom3> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: SizedBox(width: 375.w,height: 46.h,
        ...
        Expanded(
          child: SizedBox(height: 584.h,width: 400.w,
            child: ListView(
              children: [
                ...
                Padding(
                  ...
                  child: GestureDetector(onTap: (){
                    Navigator.of(context).push(MaterialPageRoute(builder: (_)=>laliga()));
                  },
                    child: Image.asset(
                      "asset/12.png",
                      width: 318.w,
